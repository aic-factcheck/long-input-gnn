...
#SBATCH --job-name hyperpartisan-01-model-hyperparams-%J
#SBATCH --output logs/hyperpartisan-01-model-hyperparams-%J.log
...
python experiments/thesis-experiments/hyperpartisan/01_model_hyperparameters.py \
