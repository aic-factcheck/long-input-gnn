...
EXPERIMENT_NAME = "multisource-model-hyperparams"
...
def experiment_main(args):
    ...
    if not args.no_log:
        wandb_logger = WandbLogger(
            ...
            name=f"hyperaparams_{args.n_layers}-layers_{args.n_heads}-heads_{args.connectivity}-topo_{args.hidden_dim}-hidden",
            log_model=True
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hidden-dim", default=128, type=int)          # 128, 256
    parser.add_argument("--connectivity", default="full", type=str)     # full, local_plus_global
