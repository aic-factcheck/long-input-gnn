...
EXPERIMENT_NAME = "THESIS-BASELINES"
...
def experiment_main(args):
    ...
    if not args.no_log:
        wandb_logger = WandbLogger(
            ...
            name=f"{dataset_name}_{args.model_name}",
            log_model=True
        )
    ...
    model = BERTClassifier(num_labels=2, learning_rate=args.lr, model_name=args.model_name)
